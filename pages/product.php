...
<body>
    ...
    <div class="products">
        ...
        <div class="products_content">
            <div>
                <div>
                    <img src="./../assets/images/books/1.jpg" alt="" srcset="">
                </div>
                <h2>Sẵn sàng tri thức cho ngày tựu trường</h2>
                <h4>100.000đ</h4>
                <button>Mua hàng</button>
            </div>
            <div>
                <div>
                    <img src="./../assets/images/books/2.jpg" alt="" srcset="">
                </div>
                <h2>Sẵn sàng tri thức cho ngày tựu trường</h2>
                <h4>100.000đ</h4>
                <button>Mua hàng</button>
            ...
            <div>
                <div>
                    <img src="./../assets/images/books/3.jpg" alt="" srcset="">
                </div>
                <h2>Sẵn sàng tri thức cho ngày tựu trường</h2>
                <h4>100.000đ</h4>
                <button>Mua hàng</button>
            ...
            <div>
                <div>
                    <img src="./../assets/images/books/4.jpg" alt="" srcset="">
                </div>
                <h2>Sẵn sàng tri thức cho ngày tựu trường</h2>
                <h4>100.000đ</h4>
                <button>Mua hàng</button>
